...
tell application "System Events"
	tell application process "Safari"
		...
		tell window 1
			click button "Password" of toolbar 1 of it
			repeat until (exists button "Aggiungi" of group 1 of group 1 of it)
				if not (exists button "Aggiungi" of group 1 of group 1 of it) then
...
repeat with i from 1 to length of recs
	...
	tell application "System Events"
		tell application process "Safari"
			set frontmost to true
			tell window 1
				click button "Aggiungi" of group 1 of group 1 of it
				-- write fields
				set value of text field 1 of sheet 1 to kcURL
				keystroke tab
				set value of text field 2 of sheet 1 to kcUsername
				keystroke tab
				set value of text field 3 of sheet 1 to kcPassword
				keystroke return
			end tell
		end tell
	end tell
